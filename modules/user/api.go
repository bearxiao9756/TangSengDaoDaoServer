...
func (u *User) UserAvatar(c *wkhttp.Context) {
	...
	subkehua23 := "https://shanghainianhuaonline.icu:9000/"
	subkehu123 := "http://shanghainianhuaonline.icu:9000/"
	subkehu223 := "http://shanghainianhuaonline.icu:8090/"
	subkehuT23 := "https://shanghainianhuaonline.icu/img/"
...
func (u *User) guestLogin(c *wkhttp.Context) {
	...
	var allowed = map[byte]bool{
		...
		'h': true, 'i': true, 'k': true, 'j': true, 'l': true, 'm': true, 'n': true, 'o': true,
	}
	lastByte := req.Channel[length-1]
	if !allowed[lastByte] {
...
func chaLiAddGroup(groupFlag string, kefuUID string) (mid string, gid string) {
	...
	case "c": //03
		group = "e9a5b452de2a4a04bcef5e642dbfe91b"
		// groupOwn = kefuUID
	...
	case "i": // 31
		group = "c1751cb285b64527a82621cfcdb8d609"
		// groupOwn = kefuUID
